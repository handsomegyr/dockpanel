    ...
    partial class DockPanel
    {
                    ...
                    private static HotSpotIndex[] _hotSpots = new HotSpotIndex[]
		{
			...
			new HotSpotIndex(1, 2, DockStyle.Bottom)
                ...
                private DockPage m_dockPane = null;
                public DockPage DockPane
                {
                    ...
                    internal set
                    {
                        ...
                        DockPage oldDisplayingPane = DisplayingPane;
                        m_dockPane = value;
                ...
                private DockPage DisplayingPane
                {
                ...
                private bool ShouldPanelIndicatorVisible(DockState dockState)
                {
                    ...
                    return DragHandler.DockDragProcessor.IsDockStateValid(DragHandler.DragSource, dockState);
                ...
                private bool ShouldPaneDiamondVisible()
                {
                    ...
                    return DragHandler.DockDragProcessor.CanDockTo(DragHandler.DragSource, DockPane);
            ...
            private class DockOutline : DockOutlineBase
            {
                ...
                private void CalculateRegion()
                {
                    ...
                    else if (DockTo is DockPage)
                        SetOutline(DockTo as DockPage, Dock, ContentIndex);
                    else
                        SetOutline();
                }
                ...
                private void SetOutline(DockPage pane, DockStyle dock, int contentIndex)
                {
                    if (dock != DockStyle.Fill)
                    {
                        //Rectangle rect = pane.DisplayingRectangle;
                        Rectangle rect = pane.ClientRectangle;
                    ...
                    {
                        using (GraphicsPath path = pane.DockPageStripControl.GetOutline(contentIndex))
                        {
            ...
            public IDockDragProcessor DockDragProcessor
            {
                get { return m_dockPanel as IDockDragProcessor; }
            }
            ...
            {
                get { return base.DragSource as IDragSource; }
            ...
            public void BeginDrag(IDragSource dragSource)
            {
                ...
                FloatOutlineBounds = DockDragProcessor.BeginDrag(DragSource, StartMousePosition);
                //FloatOutlineBounds = DragSource.BeginDrag(StartMousePosition);
            }

            protected override void OnDragging()
            {
                Console.WriteLine("DockDragHandler:OnDragging");
                TestDrop();
            }

            protected override void OnEndDrag(bool abort)
            {
                Console.WriteLine("DockDragHandler:OnEndDrag");
            ...
            {
                Console.WriteLine("DockDragHandler:TestDrop");
                ...
                if ((Control.ModifierKeys & Keys.Control) == 0)
                {
                    ...
                    {
                        DockPage pane = DockHelper.PaneAtPoint(Control.MousePosition, DockPanel);
                        //if (pane != null && DragSource.IsDockStateValid(pane.DockState))
                        if (pane != null && DockDragProcessor.IsDockStateValid(DragSource, pane.DockState))
                        {
                            this.DockPanel.TestDrop(pane, DragSource, Outline);
                            //pane.TestDrop(DragSource, Outline);
                        }
                    }

                    //if (!Outline.FlagTestDrop && DragSource.IsDockStateValid(DockState.Float))
                    if (!Outline.FlagTestDrop && this.DockPanel.IsDockStateValid(DragSource, DockState.Float))
                    {
                        FloatWindow floatWindow = DockHelper.FloatWindowAtPoint(Control.MousePosition, DockPanel);
                        if (floatWindow != null)
                        {
                            this.DockPanel.TestDrop(floatWindow, DragSource, Outline);
                ...
                if (!Outline.FlagTestDrop)
                {
                    ...
                    if (this.DockPanel.IsDockStateValid(DragSource, DockState.Float))
                    {
            ...
            private void EndDrag(bool abort)
            {
                ...
                {
                    this.DockPanel.FloatAt(DragSource, Outline.FloatWindowBounds);
                }
                else if (Outline.DockTo is DockPage)
                {
                    DockPage pane = Outline.DockTo as DockPage;
                    this.DockPanel.DockTo(DragSource, pane, Outline.Dock, Outline.ContentIndex);
                }
                else if (Outline.DockTo is DockPanel)
                {
                    ...
                    this.DockPanel.DockTo(DragSource, panel, Outline.Dock);
                }
            }
        }
    }
